...
![Yes, meetups and conferences are also about social interaction, but not like this.](nightmare.PNG "A grid of partcipants to a group call, each with their webcam on.")
...
```=html
<br>
<div style="text-align:center;"><b>“The medium is the message.”</b></div><br> 
```
...
<div style="text-align:center;"><i>If you click on the Twitch logo you'll be able to see the comments.</i></div><br>
```
