...
[![Will it deadlock? (click to zoom)](1*JrvDmC-KS7iL2Aexb-lskA.png "A table that shows when a C# program might deadlock.")]($link.asset('1*JrvDmC-KS7iL2Aexb-lskA.png'))
